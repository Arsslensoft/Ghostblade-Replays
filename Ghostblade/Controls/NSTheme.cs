...
namespace GhostLib.Gui
{
    ...
    class NSTabControl : TabControl
    {
        ...
        public NSTabControl()
        {
            ...
            P2 = new Pen(Color.FromArgb(35, 35, 35));
            P3 = new Pen(Color.FromArgb(12, 12, 12), 2);

            B1 = new SolidBrush(Color.FromArgb(17, 17, 17));
            B2 = new SolidBrush(Color.FromArgb(35, 35, 35));
            B3 = new SolidBrush(Color.FromArgb(205, 150, 0));
            B4 = new SolidBrush(Color.FromArgb(30, 30, 30));
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            PB1 = new PathGradientBrush(GP1);
            PB1.CenterColor = Color.FromArgb(17, 17, 17);
            PB1.SurroundColors = new Color[] { Color.FromArgb(12, 12, 12) };
