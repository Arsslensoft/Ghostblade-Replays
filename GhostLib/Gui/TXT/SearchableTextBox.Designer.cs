namespace GhostLib.Gui
{
    partial class SearchableTextBox
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.findDialog1 = new GhostLib.Gui.FindDialog();
            ...
            this.findDialog1.ReplaceRequested += new GhostLib.Gui.ReplaceEventHandler(this.findDialog1_ReplaceRequested);
            this.findDialog1.CancelReplaceRequested += new System.EventHandler(this.findDialog1_CancelReplaceRequested);
            this.findDialog1.SearchRequested += new GhostLib.Gui.SearchEventHandler(this.findDialog1_SearchRequested);
            // 
            // SearchableTextBox
            // 
