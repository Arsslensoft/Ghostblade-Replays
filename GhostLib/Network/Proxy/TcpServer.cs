...
[assembly: InternalsVisibleTo("GhostLib.Network.Proxy.Test")]
namespace GhostLib.Network.Proxy
{
    /// <summary>
    ...
    public class TcpServer
    {
        ...
        void StartListening(ref Socket ListeningSocket)
        {
           ...
           //if(InterfaceIndex != -1)
           // ListeningSocket.SetSocketOption(SocketOptionLevel.Tcp, SocketOptionName.MulticastInterface, (int)IPAddress.HostToNetworkOrder(7));
